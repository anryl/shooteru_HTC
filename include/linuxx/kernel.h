...
#include <stdarg.h>
#include <linuxx/linkage.h>
#include <linuxx/stddef.h>
#include <linuxx/types.h>
#include <linuxx/compiler.h>
#include <linuxx/bitops.h>
#include <linuxx/log2.h>
#include <linuxx/typecheck.h>
#include <linuxx/printk.h>
#include <linuxx/dynamic_debug.h>
...
#define BTHP_INFO_TAG "[BTHP] "
#define pr_bthp_info(fmt, ...) \
		pr_info(BTHP_INFO_TAG pr_fmt(fmt), ##__VA_ARGS__)
