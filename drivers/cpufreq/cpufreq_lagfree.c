...
#define DEF_FREQUENCY_UP_THRESHOLD			CONFIG_LAGFREE_MAX_LOAD						//70
#define DEF_FREQUENCY_DOWN_THRESHOLD		CONFIG_LAGFREE_MIN_LOAD						//70
#define FREQ_STEP_DOWN 						CONFIG_LAGFREE_FREQ_STEP_DOWN				//54000
#define FREQ_SLEEP_MAX 						CONFIG_LAGFREE_FREQ_SLEEP_MAX				//384000
#define FREQ_AWAKE_MIN 						CONFIG_LAGFREE_FREQ_AWAKE_MIN				//192000
#define FREQ_STEP_UP_SLEEP_PERCENT 			CONFIG_LAGFREE_FREQ_STEP_UP_SLEEP_PERCENT	//20
...
#define MIN_STAT_SAMPLING_RATE			\
	(MIN_SAMPLING_RATE_RATIO * jiffies_to_usecs(CONFIG_CPU_FREQ_MIN_TICKS))  			 //2*20  (40)
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		if (dbs_enable == 1) {
			...
			def_sampling_rate = 10 * latency *					//10*
